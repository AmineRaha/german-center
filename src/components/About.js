...
const About = () => {
  return (
    ...
    <Stack  direction="row" justifyContent="center" spacing={2} sx={{ overflowX: "visible"}} mb={"180px"}>

            <Stack mt={"-50px"} component={motion.div} zIndex={1}
              initial={{ x:-300, opacity: 0}}
              animate={{ x:80, opacity: 1}}
              transition={{ duration: 1.5, type: "just" }}
            >
              <Stack backgroundColor={"black"} mr={2} pt={"70px"} pb={"50px"} pr={"50px"} pl={"50px"} width={"600px"}>
            ...
            <Stack mt={"-50px"} component={motion.div} zIndex={0}
