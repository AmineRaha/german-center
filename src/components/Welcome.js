  ...
  return (
    <Box sx={{height: {xs:"70vh",sm:"89vh"}, width: "100%", display: "flex", justifyContent: "center", alignItems: "center", backgroundImage: `url(${"https://picsum.photos/1920/1080"})`, backgroundRepeat: "no-repeat", backgroundSize: "cover"}}>
        ...
        >
          ...
          <Typography  variant='h1' color="white" sx={{fontSize:{xs:"25px",sm:"40px",md:"55px",lg:"60px",xl:"80px"}, fontWeight:"700", textAlign:"center", textTransform:"uppercase", marginTop:"10px"}} component={motion.div} 
            variants={childVarient}
          >
            {t("wir_verbinden")}
          </Typography>
