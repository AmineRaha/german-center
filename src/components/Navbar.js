...
const Navbar = () => {
  ...
  return (
    <>
    <nav style={{ width: "100%", height: "90px", padding: "1rem 2rem", background: "rgba(220, 220, 220, 0.25)", backdropFilter: "blur(4px)", WebkitBackdropFilter: "blur(4px)",border: "1px solid rgba(0, 0, 0, 0.18)", position: "fixed",zIndex: 2}}>
        <Stack direction="row" sx={{ gap: { sm: '122px', xs: "40px" },  justifyContent: "space-between"}} px="20px">
            ...
            <Button color='primary' variant='contained' onClick={() => setOpen(true)} p={0}><MenuIcon color="secondary" sx={{fontSize: "32px"}}/></Button>
